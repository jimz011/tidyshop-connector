...
TidyShop works on its own, entirely on your phone. To share lists with the rest of the household,
the phones need somewhere they can all reach: the **TidyShop Connector**, a small server you host
yourself. This section is for whoever runs it. Family members who are only joining need none of
this; they can go straight to [Joining a family](../guide/family.md).
